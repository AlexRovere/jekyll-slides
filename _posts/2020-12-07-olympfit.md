...
<section>
    <section>
        ...
        <img height="400" data-src="{{ 'images/olymp/sport-nutrition.png' | relative_url }}">
    </section>
    <section>
        <h3>Trello</h3>
        <p>
        ...
        <h3>Github</h3>
        <p>
            <img height="550" data-src="{{ 'images/olymp/github-2.png' | relative_url }}">
        </p>
    </section>
</section>

<section>
    <h2>Presentation du site en fonctionnement</h2>
    <p>
...
<section>
    <h3>Comment l'ai je utilisé ?</h3>
    <img height= "600" data-src="{{ 'images/olymp/backend.png' | relative_url }}">
</section>

<section>
    <h3>Entité</h3>
    <img height= "600" data-src="{{ 'images/olymp/entity.png' | relative_url }}">
</section>

<section>
    <h3>phpMyAdmin</h3>
    <img height= "600" data-src="{{ 'images/olymp/phpmyadmin.png' | relative_url }}">
</section>
...
<section>
    <section>
        ...
        <p>
            Mise en place d'un système de paiement avec Stripe 
        </p>
...
<section>
    <section>
        <h2>Jeux d'essai</h2>
        <p>
            Test unitaire pour vérifier le bon fonctionnement des entités 
        </p>
        <img height="500" data-src="{{ 'images/olymp/test-unitaire.gif' | relative_url }}">
    </section>
     <section>
      <p>
...
<section>
    ...
    <img data-src="{{ 'images/olymp/amelioration.png' | relative_url }}">
</section>
</section>
